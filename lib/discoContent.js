...
export const DISCO_CONTENT = {
  ...
  lesco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "LESCO publishes it at https://www.lesco.gov.pk/LoadSheddingShutdownSchedule" },
      ],
    },
    background: {
      paras: [
        "LESCO was incorporated on 18 February 1998 (certificate L09415), and granted its first distribution licence on 1 April 2002, when WAPDA's power wing was unbundled into separate distribution companies, taking over the network of the former Lahore Area Electricity Board and incorporating as a public limited company. It has no generation of its own: like every distribution company it buys power from the national system and its job is delivery, metering and billing.",
      ...
      items: [
        { label: "Consumers", text: "5.89 million, per LESCO\u2019s NEPRA distribution licence (submission 21 December 2021, determined 9 May 2023). LESCO\u2019s own homepage claims 7.3 million but carries no date, so we use the dated regulatory figure." },
      ],
    },
    faqs: [
    ...
    complaints: {
      ...
      headOffice: "LESCO Head Office, 22-A Queens Road, Lahore — 042-99204820-30. Central Customer Services Centre: 042-99205248.",
      offices: [],
      officesNote: "Beyond the complaint number above, LESCO routes circle-level enquiries through its Central Customer Services Centre on 042-99205248.",
    },
  },
  ...
  iesco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "IESCO publishes it at https://iesco.com.pk/load-shedding" },
      ],
    },
    background: {
      paras: [
        "IESCO was incorporated under certificate L09490 of 1997-98, and granted its first distribution licence on 2 November 2001, in the unbundling of WAPDA's power wing, taking over the former Islamabad Area Electricity Board's network. Supplying the federal capital means its reliability is scrutinised closely, and it has historically reported among the lowest distribution losses and highest recovery rates of the distribution companies.",
      ...
      items: [
        { label: "Consumers", text: "4,287,737 as of July 2026 \u2014 3,707,868 domestic, 522,694 commercial, 19,627 industrial, 7,633 tubewell, 2,776 street light, 833 bulk and 26,289 others. It is the best-dated consumer figure any distribution company publishes." },
      ],
    },
    faqs: [
  ...
  mepco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "MEPCO publishes it at https://mepco.com.pk/load-shedding-schedule-for-consumer/" },
      ],
    },
    background: {
      paras: [
        "MEPCO was incorporated on 14 May 1998 (certificate L09522), and granted its first distribution licence on 25 April 2002, out of WAPDA's Multan Area Electricity Board when the power wing was unbundled into separate distribution companies. Its scale is the notable thing: covering thirteen districts, it serves more consumers than any other distribution company in Pakistan, which makes its performance figures disproportionately important to the national picture.",
      ],
      items: [
        { label: "Consumers", text: "7.358 million, per MEPCO\u2019s NEPRA distribution licence (submission 21 January 2022, determined 9 May 2023) \u2014 the largest consumer base of any distribution company in Pakistan." },
      ],
    },
    faqs: [
    ...
    complaints: {
      ...
      portal: CCMS,
      headOffice: "MEPCO Head Office, Khanewal Road, Multan — 061-9220095 (PBX 061-9210380-84, fax 061-9220116, rcc@mepco.com.pk).",
      offices: [],
      officesNote:
  ...
  fesco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "FESCO publishes it at http://mis.fesco.com.pk/fescoweb/old.fesco.com.pk/News/lms.asp" },
      ],
    },
    background: {
      paras: [
        "FESCO was incorporated on 21 March 1998 (certificate L09460), and granted its first distribution licence on 2 March 2002, when WAPDA's power wing was unbundled, taking over the former Faisalabad Area Electricity Board's network. It has long reported among the better recovery and loss figures of the distribution companies, which is usually attributed to the mix of a compact industrial base and a comparatively well-metered urban network.",
      ],
      items: [
        { label: "Consumers", text: "4.80 million, per FESCO\u2019s NEPRA licence submission of 28 October 2021. FESCO\u2019s own site says about 5.8 million across a population of over 26 million, undated." },
      ],
    },
    faqs: [
    ...
    complaints: {
      ...
      whatsapp: null,
      portal: CCMS,
      headOffice: "FESCO Head Office, West Canal Road, Abdullah Pur, Faisalabad — +92-41-9220184 to 9220229 (fax +92-41-9220233, ceo@fesco.com.pk).",
      offices: [],
      officesNote: "FESCO is the only distribution company in the country that publishes a genuine toll-free complaint UAN. Departmental addresses are dir_admn@, dir_cs@, dgit@ and webmaster@fesco.com.pk.",
    },
  },
  ...
  gepco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "GEPCO publishes it at https://www.gepco.com.pk/ElectricLoad.aspx" },
      ],
    },
    background: {
      paras: [
        "GEPCO was incorporated on 25 April 1998 (certificate L09498), commenced business on 5 June 1998 and was granted its first distribution licence on 23 April 2002, in the unbundling of WAPDA's power wing, taking over the network of the former Gujranwala Area Electricity Board. Serving an export-manufacturing region gives its reliability a direct economic weight: an outage in Sialkot is a missed shipment as often as an inconvenience.",
      ],
      items: [
        { label: "Consumers", text: "4.39 million, per its NEPRA licence determined 9 May 2023. GEPCO\u2019s homepage counters (4,541,103 domestic, 458,021 commercial, 88,176 industrial, 57,417 tubewell) carry no date." },
      ],
    },
    faqs: [
    ...
    complaints: {
      ...
      whatsapp: null,
      portal: CCMS,
      headOffice: "GEPCO Head Quarters, 565-A Model Town, G.T. Road, Gujranwala — CEO office 055-9200507, PABX 055-9200519-26.",
      offices: [
  ...
  hesco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "HESCO publishes shutdown notices through its own site rather than a standing schedule page, so there is no fixed URL to bookmark." },
      ],
    },
    background: {
      paras: [
      ...
      items: [
        { label: "When SEPCO was separated", text: "2010 \u2014 notified on 26 July 2010, operating from 16 August 2010 and incorporated on 23 November 2010, which is when northern Sindh stopped being HESCO territory." },
        { label: "Consumers", text: "1,196,494 \u2014 roughly 67% domestic, 14.5% commercial and 1.3% industrial \u2014 per its NEPRA supply licence of 27 December 2023." },
      ],
    },
    faqs: [
    ...
    complaints: {
      ...
      whatsapp: null,
      portal: CCMS,
      headOffice: "HESCO, 2nd Floor, WAPDA Offices Complex, Hussainabad, Hyderabad.",
      offices: [],
      officesNote: "HESCO does not publish a separate company complaint number: complaints go through the national 118 line, the 8118 SMS code and the CCMS portal, which is the route that issues a ticket number. HESCO's own Complaint Cell page carries no direct numbers.",
    },
  },
  ...
  pesco: {
    ...
    coverage: {
      paras: [
        ...
        "PESCO's territory used to be larger. The tribal districts were separated into TESCO, and on 1 July 2025 the Hazara division — Abbottabad, Mansehra, Haripur, Battagram and Kohistan — was carved out into HAZECO. Consumers in those areas now receive HAZECO bills, and an old PESCO reference number from before the transfer will not return a result.",
      ],
    },
    billLayout: {
      paras: [
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "PESCO does not publish a load-management schedule at a stable public URL. Its circle offices, listed below, are the practical route for asking about a planned shutdown in your area." },
      ],
    },
    background: {
      paras: [
        "PESCO was created in 1998, when WAPDA's power wing was unbundled into distribution companies, taking over the former Peshawar Area Electricity Board's network. Its territory has since been reduced twice: once when the tribal districts were separated into TESCO, and again on 1 July 2025 when the Hazara division began being billed by HAZECO.",
      ...
      items: [
        { label: "Consumers", text: "About 3.62 million after the HAZECO separation, down from roughly 4.4 million before it \u2014 per PESCO\u2019s licence modification filed with NEPRA in November 2024." },
      ],
    },
    faqs: [
      ...
      ["My area moved to HAZECO. Why doesn't my old PESCO number work?", "When HAZECO began operating independently on 1 July 2025, billing records for Abbottabad, Mansehra, Haripur, Battagram and Kohistan moved to HAZECO's own structure, and the sub-division portion of many reference numbers changed. Use the number from a recent HAZECO bill rather than an older PESCO one."],
    ...
    complaints: {
      ...
      portal: CCMS,
      headOffice: "PESCO, WAPDA House, Shami Road, Peshawar Cantt, Peshawar — 091-9211990 (fax 091-9212024, ceopesco@yahoo.com).",
      offices: [
  ...
  qesco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "QESCO does not publish a load-management schedule we could locate, and its website was unreachable when we checked it." },
      ],
    },
    background: {
      paras: [
        "QESCO was incorporated on 15 May 1998 (certificate CCP98-05017), and granted its first distribution licence on 30 April 2002, when WAPDA's power wing was unbundled, taking over the former Quetta Area Electricity Board's network. Uniquely among the distribution companies, its licensed territory is an entire province, which is why it is described as the sole distributor for Balochistan rather than as a regional company.",
      ...
      items: [
        { label: "Consumers", text: "0.68 million in FY 2022-23, projected to 0.867 million by FY 2023-27, per its NEPRA distribution licence. (The same determination also states \u2018about 6.76 million\u2019 in an earlier paragraph; that figure is inconsistent with QESCO\u2019s scale and with its own projections, so we do not use it.)" },
      ],
    },
    faqs: [
    ...
    complaints: {
      ...
      whatsapp: null,
      portal: CCMS,
      headOffice: "QESCO Headquarters, Office of the Chief Executive, Zarghoon Road, Quetta Cantt — 081-9203308 (fax 081-9201334).",
      offices: [],
      officesNote: "QESCO does not publish a separate company complaint number: complaints go through the national 118 line, the 8118 SMS code and the CCMS portal, which is the route that issues a ticket number. QESCO's website was unreachable when we checked, with an invalid TLS certificate on both the www and apex hosts, so the head-office number above comes from its NEPRA distribution licence.",
    },
  },
  ...
  sepco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "SEPCO publishes it at https://www.sepco.com.pk/load_shedding_schedule" },
      ],
    },
    background: {
      paras: [
      ...
      items: [
        { label: "Separated from HESCO", text: "Notification MDP/GM/HR/Dir(O&M)/PEPCO/1632-99 of 26 July 2010. SEPCO began functioning on 16 August 2010 and was incorporated with the SECP on 23 November 2010." },
        { label: "Consumers", text: "827,751 in total \u2014 651,760 running and 175,991 disconnected: 661,762 domestic, 128,414 commercial, 13,797 industrial, 9,342 agricultural and 14,436 others. SEPCO publishes no date against the figure; retrieved 16 August 2026." },
      ],
    },
    faqs: [
  ...
  tesco: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "TESCO does not publish a load-management schedule at a public URL we could verify." },
      ],
    },
    background: {
      paras: [
      ...
      items: [
        { label: "Incorporated", text: "3 July 2002, certificate of incorporation L-12028 of 2002-2003, taking over the tribal-area network from PESCO. Its distribution licence was granted on 12 August 2013. (TESCO\u2019s own Business Plan gives 2 July 2004; the licence is the stronger source.)" },
        { label: "Consumers", text: "About 0.443 million, of which roughly 90.56% are domestic, 6.67% commercial and 0.97% industrial \u2014 per TESCO\u2019s Business Plan 2025-26 to 2029-30 filed with NEPRA in November 2024. That is the highest domestic share of any distribution company in the country." },
      ],
    },
    faqs: [
    ...
    complaints: {
      ...
      whatsapp: null,
      portal: CCMS,
      headOffice: "TESCO Headquarters, 213-WAPDA House, Shami Road, Sakhi Chashma, Peshawar — 091-9212006 and 091-9212987 (fax 091-9212950).",
      offices: [],
      officesNote: "TESCO does not publish a separate company complaint number: complaints go through the national 118 line, the 8118 SMS code and the CCMS portal, which is the route that issues a ticket number. TESCO lists a Central Customer Services Centre at its headquarters; the number it prints begins 092, which appears to be a typo for the 091 Peshawar code, so we have not reproduced it.",
    },
  },
  ...
  hazeco: {
    seo: {
      ...
      description:
        "Check your HAZECO bill by reference number. Pakistan's newest distribution company, operating independently since July 2025, serving Abbottabad, Mansehra, Haripur, Battagram and Kohistan.",
    },
    intro:
      "HAZECO is Pakistan's newest distribution company, operating independently only since 1 July 2025 — which makes the reference number on an older bill the single most common reason a Hazara lookup fails.",
    coverage: {
      paras: [
    ...
    billLayout: {
      paras: [
        ...
        "The one thing specific to HAZECO is the reference number itself. When the Hazara division separated from PESCO, billing records were migrated into HAZECO's own structure and the sub-division portion of many reference numbers changed. A number copied from a pre-July-2025 PESCO bill will often return nothing at all. Always use the number printed on a recent HAZECO bill.",
      ],
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "HAZECO publishes it at https://hazeco.com.pk/load-shedding" },
      ],
    },
    background: {
      paras: [
        "HAZECO was incorporated on 31 October 2023 (incorporation number 0243576), granted distribution licence DL/10/2025 on 23 May 2025, and began independent operations on 1 July 2025, separated from PESCO to give the Hazara division its own dedicated distribution company with a head office in Abbottabad. Before that, consumers across Abbottabad, Mansehra, Haripur, Battagram and Kohistan received PESCO bills and dealt with PESCO offices in Peshawar.",
      ...
      items: [
        { label: "Consumers", text: "Around 700,000 to 800,000, inherited from PESCO. HAZECO has not yet published a precise figure." },
      ],
    },
    faqs: [
      ["My old PESCO reference number doesn't work. What happened?", "When HAZECO began operating independently on 1 July 2025, billing records for the Hazara division were migrated into HAZECO's own structure and the sub-division portion of many reference numbers changed. A number copied from a pre-July-2025 PESCO bill often returns nothing. Use the number printed on a recent HAZECO bill — it stays the same from then on."],
      ["Why was HAZECO created?", "To give the Hazara division a dedicated distribution company rather than administering it from Peshawar as part of PESCO. Independent operations began on 1 July 2025, with a head office in Abbottabad, and was intended to bring billing, complaints and maintenance closer to the region it serves."],
    ...
    complaints: {
      ...
      whatsapp: null,
      portal: CCMS,
      headOffice: "HAZECO, 426-A PMA Link Road, Jinnahabad, Abbottabad — 0992-920211 (ceo.hazeco@gmail.com).",
      offices: [],
      officesNote: "HAZECO does not publish a separate company complaint number: complaints go through the national 118 line, the 8118 SMS code and the CCMS portal, which is the route that issues a ticket number. HAZECO's website did not respond when we checked, so the head-office details above come from its NEPRA distribution licence and June 2025 correspondence.",
    },
  },
  ...
  ajk: {
    ...
    outages: {
      ...
      items: [
        { label: "Where the schedule is published", text: "The department does not publish a load-management schedule at a public URL we could verify. Its section-level complaint offices are the practical route." },
      ],
    },
    background: {
      paras: [
      ...
      items: [
        { label: "Consumers", text: "804,961 as of April 2025 \u2014 703,938 domestic, 86,174 commercial, 7,081 government and semi-government, 2,613 industrial and 5,155 others, up from 762,029 at the end of June 2023." },
        { label: "Governance", text: "Still a government department, not corporatised. It operates under the AJ&K Rules of Business 1985 (revised 2021) and holds no NEPRA licence, because NEPRA licenses distribution companies rather than provincial departments." },
      ],
    },
    faqs: [
    ...
    complaints: {
      ...
      whatsapp: null,
      portal: null,
      headOffice: "Chief Engineer Electricity, Muzaffarabad — 05822-920634 (fax 05822-920624). Chief Engineer (Poonch) 05824-920111; Chief Engineer (Mirpur) 05822-920309; Director General Commercial 05822-920879.",
      offices: [],
      officesNote: "The department does not run a single complaint number. It publishes a separate complaint office, with its own number, for each section — the list is at ajked.gok.pk/complaint-offices/. The national 118 line serves the mainland distribution companies and does not cover Azad Kashmir.",
    },
  },
};

// When the per-company content on the DISCO pages was last reviewed. Rendered as
// "Last updated" on every one of them, so the date a reader sees is a date
// somebody actually looked at the page — not the build date.
