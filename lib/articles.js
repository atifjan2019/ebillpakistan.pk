...
`,
  ...
  {
    slug: "protected-consumer-200-unit-rule",
    title: "Protected Consumer 200 Unit Rule: The Definition, and the Condition Nobody Mentions",
    navLabel: "Protected consumer rule",
    metaTitle: "Protected Consumer 200 Unit Rule — The Full Definition",
    metaDescription:
      "The notified definition of a protected consumer: 200 units a month for six months, Non-ToU only. A 5 kW sanctioned load disqualifies you at any usage.",
    publishedDate: "2026-07-14",
    lastUpdated: "2026-08-17",
    author: "atif-jan",
    faqs: [
      ["Who counts as a protected consumer in Pakistan?", "The notified definition is a Non-ToU residential consumer using 200 kWh or less per month consistently for the past 6 months (S.R.O. 1165(I)/2022, PART-II, A-1 Residential). Both halves matter: the consumption test and the Non-ToU condition. You do not apply for the status — your distribution company assigns it from the readings recorded against your reference number, and it is printed on your bill."],
      ["Can I be protected if my sanctioned load is 5 kW?", "No, and this is the condition almost every other explanation omits. Protected status is confined to Non-ToU consumers, and under clauses 3 and 4 of the same A-1 section a sanctioned load of 5 kW or above requires Time-of-Use metering and A-1(b) billing. That disqualifies the connection outright — fifty units a month would not help. Check the sanctioned load printed in your bill header."],
      ["What happens if I use 201 units in one month?", "That month breaks the run. Because domestic billing is not telescopic for unprotected consumers, the higher rate then applies to the whole month's consumption rather than to the single extra unit — a cliff edge at 200, not a gradual step."],
      ["How long before I am protected again?", "No notification states a lock-out or penalty period, so treat any specific claim about one with suspicion. What follows from a rolling six-month test is simply that the six months behind you must all be at or below the threshold again before you meet the definition."],
      ["What if my billing cycle was longer than a month?", "Then the units are pro-rated. Under the Consumer Service Manual (Revised 2025) clause 6.1.1.1(b), if the pro-rated figure is at or below 200 the excess is carried into the next billing cycle and protected status is retained for that month. Lifeline consumers get the same treatment at the 50 and 100 unit thresholds under clause 6.1.1.1(a)."],
      ["How do I check my units before the bill arrives?", "Enter your 14-digit reference number on the homepage to see your latest bill free, with no sign-up. If you are near the 200-unit line, checking every month is the only reliable way to spot a problem before the reading is taken."],
    ],
    h1: "The Protected Consumer 200 Unit Rule: The Full Definition",
    content: `
<p>The protected consumer category is worth real money — protected rates are a fraction of the unprotected ones — and almost every explanation of it online is incomplete in the same way. They all describe the 200-unit test. Very few mention the second condition, which disqualifies some households no matter how little electricity they use.</p>
<p>This guide gives the definition as it is actually notified, quotes it, and then explains both halves.</p>

<h2>The definition, as gazetted</h2>
<p>The definition lives in the Schedule of Tariff, at <a href="https://nepra.org.pk/tariff/Tariff/Notifications/2022/July/S.R.O%201165%20(I)-2022%20dated%2025-07-2022.pdf" target="_blank" rel="noopener noreferrer">S.R.O. 1165(I)/2022</a> of 25 July 2022, PART-II (Definitions and Conditions for supply of power specific to each consumer category), A-1 Residential:</p>
<blockquote class="tariff-quote">&ldquo;Protected consumers&rdquo; mean Non-ToU residential consumers consuming &le; 200 kWh per month consistently for the past 6 months.</blockquote>
<p>The same text remains in force at page 69 of <a href="https://nepra.org.pk/tariff/Tariff/Notifications/2025/07%20Jul/SRO%201287%20(I)%202025%2018-07-2025.pdf" target="_blank" rel="noopener noreferrer">S.R.O. 1287(I)/2025</a> of 18 July 2025.</p>
<p>Two conditions, joined silently by that one word at the front: <strong>Non-ToU</strong>.</p>

<h2>Condition one: 200 units, for six months</h2>
<p>The consumption test is <strong>200 kWh or less per month, consistently for the past 6 months</strong>. It is a rolling look-back: your distribution company reads the six billing months immediately behind you, and every one of them has to be at or below the threshold.</p>
<p>Note the gazette&rsquo;s word is &ldquo;consistently&rdquo;, not &ldquo;consecutive&rdquo;. In practice the two work the same way, and you will see &ldquo;six consecutive months&rdquo; everywhere including, until this update, on this page. It is a fair paraphrase — but it is a paraphrase, and when a legal category is worth this much money it is better to quote the notification and explain it than to substitute your own term for it.</p>
<p>The category is not something you apply for. It is assigned automatically from the readings recorded against your reference number, and your current status is printed on your bill. You can <a href="/">pull your latest bill free</a> with the reference number alone.</p>

<h2>Condition two: Non-ToU only — and this one disqualifies people outright</h2>
<p>This is the part that is missing almost everywhere, and it is the reason some readers of the first section will never qualify however carefully they manage their usage.</p>
<p>The definition applies only to <strong>Non-ToU</strong> residential consumers. Under clauses 3 and 4 of the same A-1 section, any consumer with a <strong>sanctioned load of 5 kW or above</strong> must be given Time-of-Use metering and billed on tariff A-1(b).</p>
<p>Put the two together:</p>
<blockquote class="tariff-quote">A household with a sanctioned load of 5 kW or more can never be a protected consumer, at any level of consumption.</blockquote>
<p>Fifty units a month makes no difference. Six years of low usage makes no difference. The connection is on a Time-of-Use tariff, and the protected category does not reach it.</p>

<h3>What sanctioned load is, and where to find it</h3>
<p>Sanctioned load is the capacity your connection was approved for, in kilowatts — not what you actually draw. It is set when the connection is installed or when you apply to have it changed, and it is what your fixed charges are calculated against.</p>
<p>It is printed <strong>in the header block of your bill</strong>, usually near the tariff code, as a figure in kW. On most ordinary domestic connections it is 1 to 3 kW. Where it is higher, it is often because the connection was sanctioned for a larger house, a shop that later became a home, or equipment that is no longer there.</p>
<p>That last case is worth acting on. If your sanctioned load is above 5 kW for equipment you no longer run, you are paying higher fixed charges every month <em>and</em> you are locked out of the protected category. Your distribution company can revise a sanctioned load on application — each of our <a href="/#companies">twelve company pages</a> lists that company&rsquo;s own offices.</p>

<h2>Lifeline is a different category, with stricter conditions</h2>
<p>Lifeline is not a synonym for protected, and it is not simply &ldquo;under 100 units&rdquo;. The same annex defines it as:</p>
<blockquote class="tariff-quote">&ldquo;Life Line Consumer&rdquo; means those residential consumers having single phase electric connection with a sanctioned load up to 1 kW. The lifeline consumers to include residential Non-Time of Use (Non-ToU) consumers having maximum of last twelve months and current month&rsquo;s consumption &le;100 units; two rates for &le; 50 and &le;100 units will continue.</blockquote>
<p>So lifeline requires a <strong>single-phase connection with a sanctioned load up to 1 kW</strong>, and its consumption test looks back <strong>twelve</strong> months rather than six. The two rates for &le; 50 and &le; 100 units sit inside that category.</p>

<h2>What crossing 200 units actually costs</h2>
<p>More than the extra units, because domestic billing is not telescopic. For an unprotected consumer every unit is charged at the rate of the band the month reaches, so crossing a boundary reprices the whole month rather than just the excess. Our <a href="/electricity-tariff">tariff guide</a> works through the arithmetic; the short version is that going from 200 to 201 units moves the entire month onto a higher rate.</p>
<p>On top of that, the month that went over is now sitting inside your six-month look-back.</p>

<h2>Getting the status back: what is known, and what is not</h2>
<p>Here is where we part company with most articles on this subject.</p>
<p><strong>No notification imposes a lock-out or a penalty period.</strong> We looked. The Schedule of Tariff defines the category and says nothing about regaining it; the Consumer Service Manual covers pro-rata billing rather than eligibility.</p>
<p>What <em>follows</em> from a rolling six-month test is straightforward: since the definition asks whether the past six months were all at or below 200 units, you meet it again once that is true again. That is an implication of how the test is written, not a separate published rule — and it is worth being clear about the difference, because you will find the stricter framing stated as settled fact in a lot of places, including in an earlier version of this page.</p>

<h2>The one relief that is written down</h2>
<p>If a billing cycle runs longer than a calendar month, you are not penalised for the extra days. Under the <a href="https://nepra.org.pk/Legislation/7-Manuals/2025/CONSUMER%20SERVICE%20MANUAL%20(CSM)%20REVISED%202025.pdf" target="_blank" rel="noopener noreferrer">Consumer Service Manual (Revised 2025)</a>, clause 6.1.1.1(b), the units are pro-rated: if the pro-rated figure is at or below 200, that portion is charged at protected rates, the excess is carried into the next billing cycle, and <strong>protected status is retained for that month</strong>. Clause 6.1.1.1(a) gives lifeline consumers the same treatment at the 50 and 100 unit thresholds.</p>
<p>So a 33-day reading that shows 208 units is not automatically the end of your protected status. If it has been treated as one, that is worth raising with your distribution company, quoting the clause.</p>

<h2>Staying under the line</h2>
<p>If you are protected and near the threshold, the practical advice is dull and it works: watch the meter rather than the calendar. Read it yourself around the third week and compare against the same point last month. The last few days of a billing cycle are where a marginal month becomes an expensive one, and an air conditioner run hard over a hot weekend can move you 30 or 40 units.</p>
<p>Check the bill each month too, free, with just your reference number — if a reading looks wrong, disputing it before the next cycle is far easier than unwinding it afterwards.</p>

<h2>Check where you stand</h2>
<p><a href="/">Enter your reference number</a> to see your current units, your tariff code and your sanctioned load — the three things that between them decide which category you are in.</p>
`,
  },

  {
    slug: "nepra-tariff-relief-2026",
    title: "The Rs 1.9857 Electricity Relief on June–August 2026 Bills: Who Gets It",
    navLabel: "Rs 1.99 tariff relief",
    metaTitle: "Rs 1.9857 Electricity Relief 2026 — S.R.O. 953(I)/2026",
    metaDescription:
      "A negative quarterly adjustment of Rs 1.9857 per unit applies to June, July and August 2026 bills under S.R.O. 953(I)/2026. Who gets it, and when it ends.",
    publishedDate: "2026-07-04",
    lastUpdated: "2026-08-17",
    author: "atif-jan",
    faqs: [
      ["How much is the relief, exactly?", "Rs 1.9857 per unit, notified in S.R.O. 953(I)/2026 of 8 June 2026 as the 1st Quarter CY 2026 quarterly tariff adjustment. It is widely reported as 'about Rs 1.99', which is the same figure rounded."],
      ["Which months does it apply to?", "The June, July and August 2026 billing months, and no others. It expires after the August billing month — a September bill will not carry it, and comparing a September bill against an August one without allowing for that will look like an unexplained increase."],
      ["Who does not get it?", "Lifeline consumers, consumers on the incremental consumption package, and prepaid consumers are excluded under the notification."],
      ["Why did my bill not fall by the full amount?", "Because the fuel charges adjustment runs in the same months and works in the opposite direction. The relief is a credit per unit; the FCA is usually a charge per unit. What you see on the bill is the net of the two, plus GST calculated on the result."],
      ["Do I need to apply for it?", "No. It is applied automatically to every eligible bill. Nobody will ever call you about it, and any message asking for a fee or a CNIC to 'release' a tariff relief is a scam."],
    ],
    h1: "The Rs 1.9857 Electricity Relief on June–August 2026 Bills",
    content: `
<p>Bills issued in June, July and August 2026 carry a credit of <strong>Rs 1.9857 per unit</strong> — a negative quarterly tariff adjustment that reduces what you pay for every unit you use. It is automatic: there is nothing to apply for and no fee to pay.</p>
<p>It is also <strong>temporary</strong>, and that is the part worth knowing before your September bill arrives.</p>

<h2>What it is, and where it comes from</h2>
<p>Your tariff is not fixed for the year. NEPRA periodically reconciles the fuel and capacity costs it originally allowed against what the power companies actually spent, and settles the gap. When the regulator has over-recovered, the difference comes back to consumers as a negative adjustment.</p>
<p>This one is the <strong>1st Quarter CY 2026 quarterly tariff adjustment</strong>, notified in <a href="https://nepra.org.pk/tariff/Tariff/Notifications/2026/06%20June/SRO%20953(I)2026%20-%20Notification%20regarding%201st%20Quarter%20CY%202026%20XW-DISCOs%2008.06.2026.PDF" target="_blank" rel="noopener noreferrer">S.R.O. 953(I)/2026</a> of 8 June 2026, at <strong>&minus;Rs 1.9857/kWh</strong>. Rather than refund it in a single month, it is spread across three billing cycles and extended to K-Electric consumers as well as the distribution companies.</p>
<p>You will see it reported as &ldquo;about Rs 1.99&rdquo;. That is the same figure rounded — the notification says 1.9857.</p>
<p>Because it is a per-unit credit, the rupee value scales with usage: a household on 300 units gets three times the cash benefit of one on 100 units, though the heavier user still has the larger bill overall.</p>

<h2>Who does not get it</h2>
<p>The notification excludes three groups:</p>
<ul>
  <li><strong>Lifeline consumers</strong> — single-phase connections with a sanctioned load up to 1 kW and very low usage.</li>
  <li><strong>Incremental consumption package</strong> consumers.</li>
  <li><strong>Prepaid</strong> consumers.</li>
</ul>
<p>Everyone else on a distribution company supply receives it automatically.</p>

<h2>Why your bill did not fall by Rs 1.9857 a unit</h2>
<p>This is the most common complaint about it, and the answer is that two adjustments run in the same months in opposite directions.</p>
<p>The quarterly adjustment is a <strong>credit</strong> per unit. The <strong>fuel charges adjustment</strong> (FCA, also written FPA) is recalculated monthly and is usually a <strong>charge</strong> per unit. Your bill shows the net effect, and then GST is calculated on the result. So the visible drop is smaller than the headline number — sometimes much smaller in a month when fuel costs ran high.</p>
<p>That is not an error and it is not the relief being withheld. Our <a href="/blog/july-2026-electricity-bill-increase-fca">guide to the fuel cost adjustment</a> covers the other half of the equation.</p>

<h2>When it ends — and why that matters in September</h2>
<p>The adjustment applies to the <strong>June, July and August 2026 billing months only</strong>. It expires after August.</p>
<p>The practical consequence is a September bill that looks higher for no obvious reason. Nothing will have changed about your usage or your tariff band; the credit will simply have stopped. If you are comparing months, compare like with like, and check whether NEPRA has notified a new adjustment for the following quarter — we track the current one on our <a href="/electricity-tariff">tariff page</a>, alongside the base schedule it is applied on top of.</p>

<h2>How to see it on your own bill</h2>
<p>Look for the quarterly tariff adjustment line in the charges column, separate from the FCA line. Both are per-unit amounts applied to the units you consumed, and both sit above the tax lines.</p>
<p><a href="/">Check your bill with your reference number</a> — free, no sign-up — and our <a href="/sample-bill-explained">annotated sample bill</a> shows where each of those lines sits.</p>

<h2>Roman Urdu: khulasa</h2>
<p>June, July aur August 2026 ke bijli bill par takreeban Rs 1.99 (asal figure 1.9857) fi unit ki relief hai, jo S.R.O. 953(I)/2026 ke tahat di gayi hai. Ye khud-ba-khud lagti hai, koi application ya fees nahi. Lifeline, prepaid aur incremental consumption package walay is se mustasna hain. Aap ka bill poore Rs 1.99 kam nahi hoga kyunke usi mahine fuel adjustment (FCA) bhi lagti hai jo iska asar kam kar deti hai. Aur yaad rahe: August ke baad ye relief khatam ho jati hai.</p>
`,
  },

  {
    slug: "july-2026-electricity-bill-increase-fca",
    title: "Why Your July 2026 Bill Went Up: The Fuel Cost Adjustment Explained",
    navLabel: "FCA on your bill",
    metaTitle: "July 2026 Electricity Bill Increase — FCA Explained",
    metaDescription:
      "The Fuel Cost Adjustment is a monthly per-unit charge that moves with generation costs. What it is, why it lags two months, and how it offsets the current relief.",
    publishedDate: "2026-07-18",
    lastUpdated: "2026-08-17",
    author: "atif-jan",
    faqs: [
      ["What is the FCA on my electricity bill?", "The Fuel Cost Adjustment, also written FPA, reconciles the fuel cost assumed in your base tariff against what generation actually cost. It is a per-unit amount recalculated every month, added when costs ran higher than assumed and credited when they ran lower."],
      ["Why does a 'May' adjustment appear on my July bill?", "Because it is calculated after the fact. Actual generation costs have to be reported and reviewed before the adjustment can be set, which puts roughly a two-month lag between the month being reconciled and the bill that carries it."],
      ["Is the FCA the same as the quarterly tariff adjustment?", "No, and they are separate lines. The FCA is monthly and tracks fuel costs. The quarterly adjustment settles capacity and other allowed costs over a defined run of months. In June to August 2026 both were live at once, working in opposite directions."],
      ["Can my distribution company waive the FCA?", "No. It is notified centrally and applied uniformly. LESCO, MEPCO, PESCO and the rest all apply the same figure — there is nothing local about it and no discretion to remove it."],
      ["How do I see what I was actually charged?", "Look for the FCA or FPA line in the charges column of your bill and divide it by your units to get the per-unit figure. Checking your own bill beats relying on any headline number, because the figure changes every month."],
    ],
    h1: "Why Your July 2026 Bill Went Up: The Fuel Cost Adjustment",
    content: `
<p>If a bill rose without your usage rising, the fuel cost adjustment is the most likely reason. It is a per-unit amount that changes every month, it is set nationally rather than by your distribution company, and it is the single biggest reason two months with identical units can produce different bills.</p>

<h2>What the FCA is</h2>
<p>The <strong>Fuel Cost Adjustment</strong> — also written as Fuel Price Adjustment, FPA — reconciles the fuel cost assumed in your base tariff against what generating the electricity actually cost. Run higher than assumed, and a positive FCA is added to every unit. Run lower, and it comes back as a credit.</p>
<p>Because it is calculated after the fact, there is a lag of roughly two months between the month being reconciled and the bill that carries it. That is why an adjustment described as being &ldquo;for May&rdquo; turns up on a July bill, which confuses a lot of people looking for a charge that matches the month printed at the top of the page.</p>

<h2>It is not the only thing moving</h2>
<p>Through June, July and August 2026 the FCA ran alongside a <strong>negative quarterly tariff adjustment of Rs 1.9857 per unit</strong>, notified in <a href="https://nepra.org.pk/tariff/Tariff/Notifications/2026/06%20June/SRO%20953(I)2026%20-%20Notification%20regarding%201st%20Quarter%20CY%202026%20XW-DISCOs%2008.06.2026.PDF" target="_blank" rel="noopener noreferrer">S.R.O. 953(I)/2026</a> of 8 June 2026.</p>
<p>The two work in opposite directions. The quarterly adjustment is a credit; the FCA is usually a charge. What lands on your bill is the net, and then GST is calculated on the result — which is why the relief felt smaller than the headline figure suggested, and why a bill can rise in a month you were told rates were falling.</p>
<p>The relief <strong>expires after the August 2026 billing month</strong>. From September the offset disappears, so an FCA of the same size will show up more visibly. Our <a href="/blog/nepra-tariff-relief-2026">guide to the Rs 1.9857 relief</a> covers that side, and the <a href="/electricity-tariff">tariff page</a> tracks both against the base schedule.</p>

<h2>Where the FCA sits relative to everything else</h2>
<p>The FCA is applied per unit, on top of the energy charge, and before tax. It is separate from your slab rate, from the fixed charge tied to your sanctioned load, and from the duty and GST lines below it.</p>
<p>Worth knowing: because GST is calculated on a subtotal that includes the FCA, a rise in the fuel adjustment increases your tax as well as your energy cost. The visible effect on the total is larger than the per-unit figure alone suggests. Our <a href="/blog/unit-slabs-fuel-price-adjustment-taxes-explained">guide to slabs, FPA and taxes</a> walks through how the layers stack.</p>

<h2>How to check what you were actually charged</h2>
<p>Do not rely on a headline number from a news report — the figure changes monthly, and what matters is the one on your bill. Find the FCA or FPA line in the charges column and divide it by your units for the per-unit amount you paid.</p>
<p><a href="/">Check your bill</a> with your reference number, free and with no sign-up. If the units themselves look wrong rather than the charges, that is a meter-reading question for your distribution company — each of our <a href="/#companies">company pages</a> lists its own complaint route.</p>

<h2>What you can actually do about it</h2>
<p>Very little directly: the FCA is notified centrally and no distribution company can waive it. What you can control is the number of units it is multiplied by. Since the adjustment is charged per unit, cutting usage cuts the FCA proportionally — and if you are near a slab boundary, the saving compounds, because <a href="/electricity-tariff">crossing a band reprices the whole month</a> for unprotected consumers.</p>

<h2>Roman Urdu: khulasa</h2>
<p>FCA (fuel cost adjustment) har mahine badalti hai aur bijli banane ki asal lagat ke hisab se lagti hai. Ye tehreeri tor par do mahine peeche ki lagat par hoti hai, isi liye &ldquo;May&rdquo; wali adjustment July ke bill par aati hai. June se August 2026 tak sath hi Rs 1.9857 fi unit ki relief bhi chal rahi thi, jo FCA ka asar kam kar rahi thi — lekin August ke baad wo relief khatam ho jati hai. Apne bill par FCA ki line dekh kar apne units se taqseem karein, asal figure wahi hai.</p>
`,
  },
...
<h2>سلیب کراس کرنے کا اصل نقصان</h2>
<p>یہ سب سے اہم بات ہے جو اکثر لوگ نہیں جانتے۔ پاکستان میں گھریلو بل <strong>ٹیلیسکوپک نہیں</strong> ہے۔ اگر آپ ان پروٹیکٹڈ صارف ہیں تو آپ کے <strong>تمام یونٹ</strong> اُسی سلیب کے ریٹ پر لگتے ہیں جس تک آپ پہنچے ہیں — صرف اوپر والے یونٹ نہیں۔</p>
<p>مثال کے طور پر، ایس آر او 279(I)/2026 کے ریٹ کے مطابق: ٹھیک 200 یونٹ پر بل 200 × 28.91 روپے = <strong>5,782 روپے</strong> بنتا ہے۔ صرف <strong>ایک</strong> یونٹ زیادہ، یعنی 201 یونٹ، تو پورا مہینہ اگلے سلیب پر چلا جاتا ہے: 201 × 33.10 روپے = <strong>6,653 روپے</strong>۔ ایک یونٹ کی قیمت تقریباً <strong>871 روپے</strong> پڑی، اور جی ایس ٹی اس کے علاوہ ہے۔</p>
<p>اسی لیے مہینے کے آخری دنوں میں میٹر پر نظر رکھنا واقعی پیسے بچاتا ہے۔ مکمل ریٹ لسٹ کے لیے دیکھیں: <a href="/electricity-tariff">بجلی کے موجودہ ٹیرف</a>۔</p>

<h2>پروٹیکٹڈ اسٹیٹس کی حفاظت کریں</h2>
<p>پروٹیکٹڈ صارف کا فی یونٹ ریٹ ان پروٹیکٹڈ سے بہت کم ہے۔ 200 یونٹ پر ایک پروٹیکٹڈ صارف کا انرجی چارج تقریباً <strong>2,355 روپے</strong> بنتا ہے، جبکہ ان پروٹیکٹڈ کا 5,782 روپے۔ یہ فرق اتنا بڑا ہے کہ اسے بچانا ہر مہینے کی کوشش کے قابل ہے۔ آپ کا اسٹیٹس بل پر ٹیرف کوڈ میں لکھا ہوتا ہے۔</p>

<h2>فکسڈ چارجز: جو بہرحال آتے ہیں</h2>
<p>بل میں کچھ رقم ایسی ہے جو یونٹ کم کرنے سے نہیں گھٹتی۔ فکسڈ چارجز آپ کے منظور شدہ لوڈ پر فی کلوواٹ لگتے ہیں، اور میٹر رینٹ، ٹی وی فیس اور ڈیوٹی بھی الگ سے شامل ہوتی ہیں۔ عام گھریلو بل میں بجلی کی اصل قیمت تقریباً دس میں سے سات روپے ہوتی ہے، باقی ایڈجسٹمنٹ اور ٹیکس ہیں — اسی لیے یونٹ کم کرنے سے بل اتنا کم نہیں ہوتا جتنی توقع ہوتی ہے۔ ہر لائن کی تفصیل کے لیے دیکھیں: <a href="/sample-bill-explained">بل کی مکمل وضاحت</a>۔</p>

<h2>میٹر ریڈنگ خود چیک کریں</h2>
<p>بل پر پچھلی اور موجودہ ریڈنگ دونوں لکھی ہوتی ہیں۔ ان کا فرق ہی آپ کے یونٹ ہیں۔ اگر یہ آپ کے استعمال سے میل نہیں کھاتا، یا کئی مہینے ایک جیسے گول نمبر آ رہے ہیں، تو ممکن ہے ریڈنگ اندازے سے لگائی گئی ہو۔ ایسی صورت میں اپنی کمپنی سے ریڈنگ کی تصدیق کرائیں — ہر <a href="/#companies">کمپنی کے صفحے</a> پر اُس کے اپنے شکایتی نمبر موجود ہیں۔</p>

<h2>اپنا بل آن لائن چیک کریں</h2>
<p>ہر مہینے اپنا بل اور یونٹ دیکھنے کے لیے <a href="/">eBill Pakistan پر اپنا بجلی کا بل چیک کریں</a> — مفت اور فوری، بغیر کسی سائن اپ کے۔</p>
`,
  },
  {
