...
`,
...

  {
    ...
    lastUpdated: "2026-07-03",
    faqs: [
      ["What is HAZECO?", "HAZECO is the Hazara Electric Supply Company, the distribution company for the Hazara division of Khyber Pakhtunkhwa. It was carved out of PESCO in January 2023 and is headquartered in Abbottabad."],
...
<p>When the Hazara region moved to HAZECO, billing records were migrated to HAZECO's own structure, and the sub-division portion of many reference numbers changed. If a number copied from an <strong>old PESCO bill</strong> is not returning a result, use the reference number from a <strong>recent HAZECO bill</strong> instead, that is the number the system recognises now. The new number stays the same month after month, so you only need to note it once.</p>
...
export const DISCO_GUIDES = {
  ...
  hazeco: [
    ...
    "how-to-download-print-electricity-bill-duplicate",
  ],
};
